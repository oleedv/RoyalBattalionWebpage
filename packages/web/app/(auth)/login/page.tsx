      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded border border-border bg-bg-secondary p-8">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded bg-[#5865F2] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#4752C4]"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
