...
ticketActions.post(
  ...
  async (c) => {
    try {
      ...
      resetSecretaryDb();
      logger.error("discord-bot", "Close ticket error", err);
...
ticketActions.post(
  ...
  async (c) => {
    try {
      ...
      resetSecretaryDb();
      logger.error("discord-bot", "Escalate ticket error", err);
      return fail(c, "Secretary database unavailable", 503);
    }
  }
);
...
ticketActions.post(
  ...
  async (c) => {
    try {
      ...
      resetSecretaryDb();
      logger.error("discord-bot", "Reopen ticket error", err);
      return fail(c, "Secretary database unavailable", 503);
    }
  }
);
...
ticketActions.post(
  ...
  async (c) => {
    try {
      ...
      resetSecretaryDb();
      logger.error("discord-bot", "Force close ticket error", err);
      return fail(c, "Secretary database unavailable", 503);
    }
  }
);
